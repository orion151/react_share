...
const routes = [
  ...
  {
    path: 'products',
    component: asyncComponent(() => import('../FirestoreCRUD/Product')),
  },
  {
    path: 'promotions',
    component: asyncComponent(() => import('../FirestoreCRUD/Promotion')),
  },
  {
    path: 'customers',
    component: asyncComponent(() => import('../FirestoreCRUD/Customer')),
  },
  {
    path: 'orders',
    component: asyncComponent(() => import('../FirestoreCRUD/Order')),
  },
  {
    path: 'newid_report',
    component: asyncComponent(() => import('../NewIDReport/antTables')),
  },
  {
    path: 'salessummary_report',
    component: asyncComponent(() => import('../SalesSummaryReport/antTables')),
  },
  {
    path: 'customeraging_report',
    component: asyncComponent(() => import('../CustomerAgingReport/antTables')),
  },
  {
    path: 'contacts',
